...
-- imgui.constant.InputTextFlags.CtrlEnterForNewLine
-- imgui.constant.InputTextFlags.ReadOnly
-- imgui.constant.InputTextFlags.EscapeClearsAll
...
function DrawImguiFrame()
  ...
  drawInputText(mem, 0x80060170, 'name', 16 )
